...
the firmware straight from your browser over USB, with nothing to download or
install. The flasher detects whether the connected board is a classic ESP32 CYD
or an ESP32-S3 Waveshare panel and selects the matching image automatically.
Both images are included in every release.
