...
| `mock_os.py` | Runnable mock of the controller's API (serves `/jn`, `/jc`, `/js`; accepts `/cm`, `/cv`). |
...
station and run it, step Prev/Advance (wrapping), jump via the grid, extend by
